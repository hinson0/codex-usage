...
assert_equal "$(plutil -extract CFBundleShortVersionString raw "$info")" "1.0.2" "Short version"
assert_equal "$(plutil -extract CFBundleVersion raw "$info")" "11" "Build number"
