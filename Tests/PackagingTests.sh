...
assert_equal "$(plutil -extract CFBundleShortVersionString raw "$info")" "1.1.4" "Short version"
assert_equal "$(plutil -extract CFBundleVersion raw "$info")" "16" "Build number"
