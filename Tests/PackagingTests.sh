...
assert_equal "$(plutil -extract CFBundleShortVersionString raw "$info")" "1.0.1" "Short version"
assert_equal "$(plutil -extract CFBundleVersion raw "$info")" "10" "Build number"
