...
assert_equal "$(plutil -extract CFBundleShortVersionString raw "$info")" "1.1.1" "Short version"
assert_equal "$(plutil -extract CFBundleVersion raw "$info")" "13" "Build number"
