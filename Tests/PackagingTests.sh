...
assert_equal "$(plutil -extract CFBundleShortVersionString raw "$info")" "1.1.2" "Short version"
assert_equal "$(plutil -extract CFBundleVersion raw "$info")" "14" "Build number"
