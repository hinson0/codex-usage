...
assert_equal "$(plutil -extract CFBundleShortVersionString raw "$info")" "0.4.1" "Short version"
assert_equal "$(plutil -extract CFBundleVersion raw "$info")" "5" "Build number"
