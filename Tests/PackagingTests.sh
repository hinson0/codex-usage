...
assert_equal "$(plutil -extract CFBundleShortVersionString raw "$info")" "1.0.0" "Short version"
assert_equal "$(plutil -extract CFBundleVersion raw "$info")" "9" "Build number"
