...
assert_equal "$(plutil -extract CFBundleShortVersionString raw "$info")" "1.1.0" "Short version"
assert_equal "$(plutil -extract CFBundleVersion raw "$info")" "12" "Build number"
