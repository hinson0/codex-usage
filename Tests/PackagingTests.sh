...
assert_equal "$(plutil -extract CFBundleShortVersionString raw "$info")" "0.4.2" "Short version"
assert_equal "$(plutil -extract CFBundleVersion raw "$info")" "6" "Build number"
