...
assert_equal "$(plutil -extract CFBundleShortVersionString raw "$info")" "0.4.0" "Short version"
assert_equal "$(plutil -extract CFBundleVersion raw "$info")" "4" "Build number"
