...
assert_equal "$(plutil -extract CFBundleShortVersionString raw "$info")" "0.4.3" "Short version"
assert_equal "$(plutil -extract CFBundleVersion raw "$info")" "7" "Build number"
