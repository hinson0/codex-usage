...
assert_equal "$(plutil -extract CFBundleShortVersionString raw "$info")" "0.4.4" "Short version"
assert_equal "$(plutil -extract CFBundleVersion raw "$info")" "8" "Build number"
