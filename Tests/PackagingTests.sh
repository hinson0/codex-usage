...
assert_equal "$(plutil -extract CFBundleShortVersionString raw "$info")" "1.1.5" "Short version"
assert_equal "$(plutil -extract CFBundleVersion raw "$info")" "17" "Build number"
